...
const accordionItems = [
  ...
  },
  {
    ...
    content: "Cooling System Maintenance involves inspecting the compressor, replacing the air filter, and cleaning the coolant system. It helps prevent overheating and ensures your vehicle's cooling system functions efficiently."
  },
  {
    title: "What does the Brake System Checkup involve?",
    content: "The Brake System Checkup includes an examination of brake fluid, pedal spring inspection, and necessary spring maintenance. It ensures your brakes are in optimal working condition for safety."
  },
  {
    title: "What are the Additional Vehicle Services offered?",
    content: "Additional Vehicle Services encompass various options, such as body repair and painting, steering system inspection, and starter/charging system service, addressing a wide range of vehicle needs."
  },
];
