    ...
    <div>
      <section className="md:px-16 px-6 py-16 lg:py-0 text-gray-600 body-font">
        <div className="grid md:grid-cols-2 items-center gap-24">
          <div>
            <h1 className="lg:text-4xl mb-1 text-3xl font-bold tracking-wide text-balablue">
              Spoil yourself with
              <br className="hidden lg:inline-block" />
              <span className="md:leading-normal leading-snug"> convenient car care</span>
            </h1>
            <div className="flex mb-4 justify-start">
              <div className="w-12 h-1 rounded-full bg-primary inline-flex"></div>
            </div>
            <p className="mb-6 md:mb-8 text-lg leading-relaxed">
              On-demand car care to transform your vehicle at home or at work.
              All we need is your keys.
            </p>
