      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-5">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            ...
            Lubesurgeons - Your Mobile Mechanic Solution. Experience hassle-free vehicle maintenance.
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm col-span-2">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800 transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">Address:</p>
