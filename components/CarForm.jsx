...
function CarForm() { 
  ...
  const selectedBrandData = carData.find(
  ...
  return (
    <div>
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Your appointment has been succcessfully booked. We’ve sent
      ...
      <div className="mx-auto px-4 px-md:px-8 lg:px-24 xl:px-30">
        <div>
          <h1 className="sm:text-4xl text-2xl font-bold title-font py-4 text-balablue">
            Start your booking
          </h1>
        </div>
        <form onSubmit={handleSubmit}>
          <h2 className="sm:text-2xl text-xl font-medium title-font mb-2 mt-4 text-secondary">
          ...
          <div className="grid grid-cols-3 my-6">
            ...
            {errors.service && (
              <p className="text-red-500 text-xs italic ml-6 mt-1">
                {errors.service}
              </p>
            )}
            </div>
          </div>
          <h2 className="sm:text-2xl text-xl font-medium title-font mb-4 mt-4 text-secondary">
          ...
          <h2 className="sm:text-2xl text-xl font-medium title-font mb-4 mt-8 text-secondary">
