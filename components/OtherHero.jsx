        ...
        <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
          <div className="mb-6 sm:mx-auto">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50">
              <svg className="w-10 h-10 text-primary" stroke="currentColor" viewBox="0 0 52 52">
                <polygon
                  strokeWidth="3"
                  strokeLinecap="round"
          ...
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 className="max-w-lg mb-6 text-3xl font-bold leading-relaxed md:leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
